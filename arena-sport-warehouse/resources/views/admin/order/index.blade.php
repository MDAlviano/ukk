    ...
    <div class="m-10 flex flex-col gap-8">
        ...
        <form method="GET" class="flex flex-row gap-6 items-end">
            ...
            <div class="flex flex-col gap-2">
                ...
                <select name="status" class="px-5 py-3 rounded-lg border border-gray-300 focus:outline-1" onchange="this.form.submit()">
            ...
            <div class="flex flex-col gap-4">
                ...
                @foreach($orders as $order)
                    <div class="w-full h-fit bg-white rounded-lg drop-shadow-lg py-3 px-8 flex flex-col gap-3">
                        ...
                        <span class="bg-[#B6B6B6] opacity-70 w-full h-[1px]"></span>
                        <a href="{{ route('admin.orders.show', ['orderNumber' => $order->order_number]) }}" class="text-[#B6B6B6] hover:underline">Details...</a>
                    </div>
                @endforeach
            </div>
        @endif
